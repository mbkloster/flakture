...
export default class ApplicationComponent {
    ...
    // ==========================================================================
    createElem(tagName, { appendAfter = null, appendBefore = null, appendTo = null, attributes = {}, children = [], eventHandlers = {}, forceIndex = undefined, isSvg = false, prependTo = null } = {}) {
    ...
    ;
    // ==========================================================================
    createHtmlElem(tagName, { appendAfter = null, appendBefore = null, appendTo = null, attributes = {}, eventHandlers = {}, children = [], prependTo = null } = {}) {
        return this.createElem(tagName, { appendAfter, appendBefore, appendTo, attributes, eventHandlers: eventHandlers, isSvg: false, children, prependTo });
    }
    // ==========================================================================
    createSvgElem(tagName, { appendAfter = null, appendBefore = null, appendTo = null, attributes = {}, eventHandlers = {}, children = [], prependTo = null } = {}) {
        return this.createElem(tagName, { appendAfter, appendBefore, appendTo, attributes, eventHandlers: eventHandlers, isSvg: true, children, prependTo });
    }
    // ==========================================================================
    elem(className, ifNotPresent = null) {
    ...
    // ==========================================================================
    ensureElem(className, tagName, createElemAttributes = {}, setAttributesIfExists = true, replaceChildren = true) {
        try {
    ...
    // ==========================================================================
    fontAwesomeElement(style, iconName, customClassName) {
        const createElement = () => {
    ...
    // ==========================================================================
    setElementAttributes(elem, attributeMap) {
