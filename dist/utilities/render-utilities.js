...
// ==========================================================================
export const deriveRenderRatio = (desiredW, desiredH, additionalW, additionalH) => {
...
// ==========================================================================
export const destinationConflictPoints = (gameProperties, gameState, turn, pieceCodex) => {
                ...
                opponentPieceIndexes.forEach(opponentPieceIndex => {
                    ...
                    if (!opponentPiece.dead) {
                        ...
                        if (pieceDistSq < ruleset.PIECE_R * ruleset.PIECE_R * 4) {
                            conflictPoints.push({ ...firstCollisionPointOnLine(opponentPiece, { from: prevPoint, to: closestPoint }, ruleset.PIECE_R), showForSide: side });
                        }
                    }
                });
...
// ==========================================================================
export const flagEntryPoint = (ruleset, posA, posB, flagSide) => {
...
// ==========================================================================
export const gameContextTurnText = (turn) => {
    if (turn.turnNumber === 0) {
        return "Setup";
    }
    return `${turn.turnNumber}${ordinalSuffix(turn.turnNumber)}`;
};
//# sourceMappingURL=render-utilities.js.map