import { Coord, CtfGameMovementPiece, CtfGameProperties, CtfGameState, Line, Piece, Side, Turn } from "./common-types";
import Flakture from "components/flakture";
export declare const redeployedPieceMap: (flakture: Flakture) => Record<string, {
    x: number;
    y: number;
}>;
export declare const deriveDeadPieceCount: (pieces: Piece[], side: Side, movementPieces?: Record<number, CtfGameMovementPiece>) => number;
