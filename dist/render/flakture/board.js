...
function isLooseFlag(flagState) {
    ...
    return flagState.x !== undefined;
}
// ==========================================================================
const flagCenter = (ruleset, side, gameState, movement) => {
    ...
    const holdingPiece = movement?.pieces[flag] || gameState.pieces[flag];
    return { x: holdingPiece.x, y: holdingPiece.y - ruleset.PIECE_R * 0.8 };
};
// ==========================================================================
const flagLooseCircleProps = (center, loose) => {
...
// ==========================================================================
const willpowerBidTextRenderPos = (flakture, side) => {
...
const renderDestinationForPiece = (flakture, pieceIndex, pieceStart, destPoints) => {
    let previousPoint = pieceStart;
...
// ==========================================================================
export const renderHoveredPiece = (flakture) => {
    const { renderRatio, ruleset } = flakture;
...
// ==========================================================================
export const renderInitialBoard = (flakture) => {
...
// ==========================================================================
export const renderMovedPieces = (flakture) => {
...
// ==========================================================================
export const renderRedeployedPieces = (flakture) => {
...
// ==========================================================================
export const renderRedeployPoint = (flakture) => {
...
// ==========================================================================
export const renderRedeployLine = (flakture) => {
    if (!flakture.redeploying || !flakture.selectedSide) {
...
// ==========================================================================
export const renderSelectedPiece = (flakture) => {
    const { renderRatio } = flakture;
...
// ==========================================================================
export const renderWillpowerBids = (flakture) => {
...
// ==========================================================================
export const renderWillpowerBidOpacities = (flakture, opacity) => {
...
// ==========================================================================
export const rerenderGameContextTurn = (flakture) => {
    const turn = flakture.currentTurn();
...
// ==========================================================================
export const rerenderWillpowerBids = (flakture) => {
    const turn = flakture.currentTurn();
