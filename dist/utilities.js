...
// ==========================================================================
export const closestOnLineToPoint = (point, line) => {
...
export const firstCollisionPointOnLine = (coord, line, withinPx) => {
...
// ==========================================================================
export const orderNumber = (piece) => {
    return parseInt(piece.name.replace(piece.side, ""));
};
// ==========================================================================
export const opponentSide = (side) => {
    return side === Side.left ? Side.right : Side.left;
};
// ==========================================================================
const addRedeployLines = (ruleset, lines, startX, y, potentialBlockers) => {
    ...
    for (let i = 0; i < ruleset.REDEPLOY_TICK_COUNT; i++) {
        ...
        for (let j = 0; j < potentialBlockers.length; j++) {
            ...
            if (potentialBlocker.x > tick.x + (PIECE_R + expandedR)) {
                break;
            }
...
// ==========================================================================
export const redeployLines = (gameProperties, gameState, turn, side) => {
    let lines = [];
