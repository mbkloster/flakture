...
describe("CTF State assembly",  function () {
    it("assembles a valid formation or two,  then a valid state",  async () => {
        ...
        expect(xPoses1).toEqual([
            481,  481,  481,  386,  386,  386,  386,  386,  386,  243.5,  243.5,  243.5,  243.5,  243.5,  101,  101,  101,  101,  101,  101,  101
        ]);
        ...
        expect(xPoses2).toEqual([
            481, 481, 481, 481, 481, 481, 481, 481, 481, 481, 386, 386, 386, 196, 196, 196, 6, 6, 6, 6, 6
        ]);
